...
courseRouter.put("/add-reply-review", auth_1.isAuthenticated, (0, auth_1.authorizeRoles)("admin"), course_controller_1.addReplyToReview);
courseRouter.get("/get-all-courses-admin", auth_1.isAuthenticated, (0, auth_1.authorizeRoles)("admin"), course_controller_1.getAllCoursesAdmin);
...
courseRouter.post("/generateVideoUrl", course_controller_1.generateVideoUrl);
