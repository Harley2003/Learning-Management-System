...
import CourseAnalytic from "@/app/components/Admin/Analytics/CourseAnalytic";
...
const DashboardWidgets: FC<Props> = ({ open }) => {
    ...
    return (
        <div className="mt-[30px] min-h-screen">
            <div className="grid grid-cols-1 md:grid-cols-[100%,25%]">
                <div className="p-4 md:p-8">
                    <UserAnalytic isDashboard={true} />
                </div>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-[30px]">
                <div className="dark:bg-[#111c43] w-[92%] h-[40vh] shadow-sm m-auto">
                    <OrdersAnalytic isDashboard={true} />
                </div>
                <div className="dark:bg-[#111c43] w-[92%] h-[40vh] shadow-sm m-auto">
                    <CourseAnalytic isDashboard={true} />
                </div>
            </div>
        </div>
    );
