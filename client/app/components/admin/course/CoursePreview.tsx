    ...
    return (
        <div className="w-[90%] m-auto py-5 mb-5">
            <div className="w-full relative">
                ...
                <div className="flex items-center">
                    <div
                        className={`${styles.button} !w-[180px] my-3 font-Poppins ${
                            courseData?.price <= 0 ? "!bg-[#37a39a] cursor-pointer" : "!bg-[crimson] cursor-not-allowed"
                        }`}
                    >
                        {courseData?.price <= 0 ? "Enter to Course" : `Buy Now ${courseData?.price}$`}
                    </div>
                </div>
                <p className="pb-1">
