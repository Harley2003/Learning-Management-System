...
const ReviewCard: FC<Props> = ({ item }) => {
  return (
    <div className="w-full h-max pb-4 dark:bg-slate-500 dark:bg-opacity-[0.20] border border-[#00000028] dark:border-[#ffffff1d] backdrop-blur shadow-[bg-slate-700] p-3 rounded">
      ...
      <p className="pt-2 px-2 font-Poppins dark:text-white text-black">
        {item.comment}
      </p>
    </div>
  );
